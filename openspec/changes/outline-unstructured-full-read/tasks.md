...
- [ ] 2.1 按 `docs/navigation.md` 读取 `docs/CODING_STYLE.md`、`docs/cli.md`、`docs/protocol.md`、`docs/output.md`、`docs/mcp.md`、`docs/adapters/markdown.md`、`docs/testing.md` 和 `docs/testing/case-maintenance.md` 中与本 change 相关的 owner 规则。
...
- [ ] 2.6 更新 `docs/mcp.md`、JSON schema 索引和 examples，覆盖 `document_outline` 的 structured/unstructured union shape。

## 3. 协议、Schema 与输出类型

- [ ] 3.1 更新 shared protocol/result 类型，使 outline success result 支持 structured 和 unstructured 两个分支。
- [ ] 3.2 更新 protocol JSON schema、readable JSON schema 和 MCP outputSchema，使非结构化 outline result 不要求 entries、ref 或 page。
...
- [ ] 5.4 更新 MCP mapping 和示例测试，验证 `document_outline` 对 unstructured result 只做 thin mapping。
