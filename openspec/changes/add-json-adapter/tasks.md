...
- [ ] 5.3 同步更新测试策略、release docs、完整当前树的 machine test-evidence inventory 与派生索引、coverage mapping，以及受 JSON manifest/probe/example 影响的验证材料；只为不能从入口事实机械恢复、且具有长期审查价值的判断维护 Evidence Claim。
