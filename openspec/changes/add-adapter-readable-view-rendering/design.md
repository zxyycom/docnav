...
- [Risk] 实现者把 Markdown 的 md-like 省略要求误认为通用 hook 要求 -> Mitigation: readable-view-output 只定义 hook/fallback/machine-output 边界，Markdown 的省略、ref 和 continuation 文案只写在 markdown-navigation。
