...
- Core 维护一个统一静态 adapter registry，作为 adapter id、static descriptor、capabilities、source-level native option registry entries、operation handler bindings 和 adapter layer implementation 的 compile/package-time 事实源。
