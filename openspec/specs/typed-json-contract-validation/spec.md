# typed-json-contract-validation Specification

## Purpose
Define the runtime typed-field JSON contract validation requirements for Docnav protocol, manifest, and probe surfaces while keeping public JSON Schema as verification material.
## Requirements
