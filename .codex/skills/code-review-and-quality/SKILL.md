...
description: >-
  ...
  involving CLI、adapter、ref、pagination、raw/readable output、schema 或 Change Plan artifacts.
---
...
2. Docnav contract、CLI/adapter/ref/pagination/raw-readable/schema/Change Plan 相关 diff：读 [docnav-review-cues.md](references/docnav-review-cues.md)。
