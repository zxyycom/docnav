...
默认只读本文件。Docnav CLI、Rust adapter、schema/example/docs、Change Plan、决策/调查集合或 workspace verifier 相关细节，读 [docnav-contract-validation-automation.md](references/docnav-contract-validation-automation.md)。
