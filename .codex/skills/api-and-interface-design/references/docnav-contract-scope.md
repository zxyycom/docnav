...
- Ref: adapter-owned opaque identifier；core、其它入口只原样传递。
...
- CLI、adapter、schema/example 或 docs boundary changes: run the relevant smoke/integration checks; for cross-boundary Docnav work, use the repository workspace verifier when feasible.
