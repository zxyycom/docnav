...
- **Machine/readable output:** 当 protocol field shape、warning/error envelope 或 output mode 变化时，验证 protocol schema/example 或 readable-view text assertions/conformance。
...
- `protocol-json`、`readable-view` text、fixtures 或 documentation examples 变化时，使用对应 schema/example validation 或 text conformance。
