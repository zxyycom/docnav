...
示例只证明 protocol/readable、manifest 和 probe 的 documented shape。direct CLI warning placement、protocol-json stdout purity、adapter machine command 边界和 pagination mechanics 由主规范、smoke 和 Rust 测试共同证明。
