...
Entry:
- `test/smoke/core/cases/auto-read.ts > smoke task CORE-AUTO-READ-001`

Contract:
- `docs/navigation-input-resolution.md` 定义或约束“Core unique-ref auto-read 默认值与关闭来源可观察”所涉及的稳定行为边界。
