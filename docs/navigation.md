...
| 写测试或验证脚本 | [测试策略](testing.md)、[JSON Schema 索引](schemas/json-schema.md)、[示例](examples/README.md) | [覆盖矩阵](testing/coverage.md)、[Smoke Case 清单](testing/smoke-cases.md)、对应实现面的主规范 |
