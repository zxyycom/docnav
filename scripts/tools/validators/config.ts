...
export const PROTOCOL_EXAMPLE_FILE = {
  request: (operation: any) => `docs/examples/json/protocol-${operation}-request.json`,
  response: (operation: any) => `docs/examples/json/protocol-${operation}-response.json`,
  responseName: (operation: any) => `protocol-${operation}-response.json`
};

export const READABLE_EXAMPLE_FILE = {
  result: (operation: any) => `docs/examples/json/readable-${operation}.json`
};

export const MCP_EXAMPLE_FILE = {
  response: (operation: any) => `docs/examples/json/mcp-${operation}-response.json`
};
