...
import { validateReleasePackage } from "./validation.mjs";
...
function buildPackageFiles(packageDir, target) {
...
function createManifest(version, target, files) {
  return {
    schema_version: 1,
    product: "docnav",
    version,
...
function writeChecksums(layout, manifest) {
