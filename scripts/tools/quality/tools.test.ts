...
import { parseLizardCSV } from "./tools/lizard.ts";
import {
  getCpdLanguageForCodeArea,
  parseCpdXml,
...
describe("quality tool output parsing", () => {
  ...
  it("parses PMD CPD language, version, and XML output", () => {
    ...
    assert.equal(getCpdLanguageForCodeArea("node-production-scripts"), "typescript");
