...
export function scanInfo(metrics, options) {
...
export function comparisonInfo(metrics) {
...
export function repositorySize(metrics) {
...
export function footer(metrics, options) {
...
function baselineUnavailableReason(status) {
...
export function formatReportTimestamp(timestamp, timeZone) {
...
function fingerprintTable(metrics) {
...
function appendLanguageTable(lines, agg) {
...
function appendCodeAreaTable(lines, agg) {
