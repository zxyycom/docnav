...
import { getCpdLanguageForCodeArea, scanWithCpdAsync, type CpdScanResult } from "./tools/cpd.ts";
import type {
  CodeAreaFileMap,
  CodeAreaFingerprint,
