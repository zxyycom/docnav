...
import { readJsonFile, readTextFile, sha256File } from "./io.mjs";
...
function validateManifestLocation(manifestPath, packageDir, manifest) {
  assert(
...
function validateManifestMetadata(manifest, options) {
...
function validateManifestFiles(files, expectedFileNames) {
...
function validateManifestFile(entry) {
...
function validatePackageDirectory(packageDir, expectedFileNames) {
