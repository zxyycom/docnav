...
import { findCargoExecutable } from "./tools/cargo.mjs";
...
function usage(message) {
  ...
  console.error("usage: node scripts/build-docnav-dev-bins.mjs [--quiet] [--output-env-json <path>]");
  process.exit(2);
}
