 ...
 */
export function locateBaselineCommit({ cwd, scanInputPaths }) {
  // 获取 HEAD commit
 ...
 */
export function materializeBaseline({ commitSha, cwd, baselineWorkDir }) {
 ...
 */
export function detectTextOnlyChange({ baselineSha, cwd, scanInputPaths }) {
  if (!baselineSha) {
 ...
 * @returns {string[]}
 */
export function getChangedFiles(commitSha, cwd) {
...
function getCommitDate(sha, cwd) {
...
export function getWorkingTreeChangedFiles(cwd, scanInputPaths) {
