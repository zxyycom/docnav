...
export function duplicateCodeSection(metrics) {
  const lines = [];
  lines.push("## 重复代码检测");
  lines.push("");
...
function requireDuplicateAreas(dup) {
...
function requireDuplicateLocations(dup) {
...
function formatDuplicateLocation(dup, location) {
...
export function changedFilesSection(metrics) {
  const lines = [];
...
export function trendSection(metrics) {
  const lines = [];
...
export function warningsSection(metrics) {
  const lines = [];
  lines.push("## Warnings");
  lines.push("");
