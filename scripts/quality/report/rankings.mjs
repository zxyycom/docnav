...
export function fileRankings(metrics, topN) {
  const lines = [];
...
export function fileComplexityRankings(metrics, topN) {
  const lines = [];
...
export function functionComplexityRankings(metrics, topN) {
  const lines = [];
...
export function functionSizeRankings(metrics, topN) {
  const lines = [];
