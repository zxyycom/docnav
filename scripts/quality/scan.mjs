...
import { createEmptyMetrics } from "./schema.mjs";
import { classifyFiles } from "./classify.mjs";
import {
  materializeBaseline,
  detectTextOnlyChange
} from "./baseline.mjs";
import { generateWarnings } from "./warnings.mjs";
import {
  collectScanFiles,
  getChangedFileList,
  buildFingerprints
} from "./files.mjs";
import { scanCurrentRevision } from "./scan-runner.mjs";
import { scanBaselineRevision } from "./baseline-scan.mjs";
import { generateTrends } from "./trends.mjs";
import {
  parseArgs,
  prepareArtifactDirs,
...
export { scanBaselineRevision } from "./baseline-scan.mjs";
export { buildAggregates } from "./aggregate.mjs";
export { generateTrends } from "./trends.mjs";
