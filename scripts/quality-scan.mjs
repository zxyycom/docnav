...
import { DEFAULT_CONFIG } from "./tools/quality/config.mjs";
import { createEmptyMetrics } from "./tools/quality/schema.mjs";
import { classifyFiles } from "./tools/quality/classify.mjs";
import {
  materializeBaseline,
  detectTextOnlyChange
} from "./tools/quality/baseline.mjs";
import { generateWarnings } from "./tools/quality/warnings.mjs";
import {
  collectScanFiles,
  getChangedFileList,
  buildFingerprints
} from "./tools/quality/files.mjs";
import { scanCurrentRevision } from "./tools/quality/scan-runner.mjs";
import { scanBaselineRevision } from "./tools/quality/baseline-scan.mjs";
import { generateTrends } from "./tools/quality/trends.mjs";
import {
  parseArgs,
  prepareArtifactDirs,
  ...
  formatFatalIssue,
  getGitSha
} from "./tools/quality/scan-cli.mjs";

export { scanBaselineRevision } from "./tools/quality/baseline-scan.mjs";
export { buildAggregates } from "./tools/quality/aggregate.mjs";
export { generateTrends } from "./tools/quality/trends.mjs";
...
function maybeScanBaseline({ metrics, toolResults, rawDir, fatalIssues }) {
...
function scanMaterializedBaseline({ metrics, toolResults, rawDir, baselineWorkDir }) {
