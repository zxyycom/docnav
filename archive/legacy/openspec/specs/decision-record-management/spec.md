...
#### Scenario: 未对齐方向参与相关工作
- **WHEN** 一条活动未对齐决策适用于当前工作
- **THEN** agent MUST 将完整决策恢复为已确认但尚未成为当前事实的未来方向
- **THEN** 当前选择 MUST 在满足本次任务的可行方案中优先保留通向该方向的路径
- **THEN** 当前实施范围 MUST 由当前任务确定，未来先后关系 MAY 由决策正文表达
- **THEN** 当前任务范围已经覆盖该方向时 MAY 一并推进
